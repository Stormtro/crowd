...
function MisCampañas() {
  return (
    ...
    <div className="w-full bg-white my-11">
      <div className="flex items-center justify-center  gap-36 max-lg:flex max-lg:flex-col max-lg:gap-8">
        <button
          id="Panel"
          className="btn btn-active bg-[#CFD8D7] text-black hover:bg-white"
        >
    ...
    <div id="" className="flex">
      <div id="swich" className="order-2 w-full mt-8 "></div>
      <div className="order-1 bg-blue max-lg:hidden">
        <img className="" src="../img/enredadera.png" alt="" />
      </div>
      <div className="order-3 bg-blue max-lg:hidden">
